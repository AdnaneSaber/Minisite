...
const Nav = () => {
  ...
  return (
    <header>
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 mb-16 dark:bg-dark border-b-gray-400 dark:border-b-gray-700 border-b border-opacity-40">
        <div className="flex flex-wrap justify-between items-center container mx-auto px-5">
            ...
            <form action="#" method="GET" className="hidden lg:block lg:pl-2">
              ...
              <div className="relative mt-1 lg:w-96">
                ...
                <input
                  ...
                  name="email"
                  id="topbar-search"
                  className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 dark:bg-dark dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                  placeholder={"Search"}
                />
              </div>
            </form>
